...
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1 << 39)
#define MASK_PREFER_AVX128 (1 << 20)
#define OPTION_MASK_ISA_PREFETCHWT1 (HOST_WIDE_INT_1 << 40)
#define OPTION_MASK_ISA_PRFCHW (HOST_WIDE_INT_1 << 41)
#define OPTION_MASK_ISA_RDRND (HOST_WIDE_INT_1 << 42)
#define OPTION_MASK_ISA_RDSEED (HOST_WIDE_INT_1 << 43)
#define MASK_RECIP (1 << 21)
#define MASK_RTD (1 << 22)
#define OPTION_MASK_ISA_RTM (HOST_WIDE_INT_1 << 44)
#define OPTION_MASK_ISA_SAHF (HOST_WIDE_INT_1 << 45)
#define OPTION_MASK_ISA_SHA (HOST_WIDE_INT_1 << 46)
#define OPTION_MASK_ISA_SSE (HOST_WIDE_INT_1 << 47)
#define OPTION_MASK_ISA_SSE2 (HOST_WIDE_INT_1 << 48)
#define OPTION_MASK_ISA_SSE3 (HOST_WIDE_INT_1 << 49)
#define OPTION_MASK_ISA_SSE4_2 (HOST_WIDE_INT_1 << 50)
#define OPTION_MASK_ISA_SSE4A (HOST_WIDE_INT_1 << 51)
#define MASK_SSEREGPARM (1 << 23)
#define OPTION_MASK_ISA_SSSE3 (HOST_WIDE_INT_1 << 52)
#define MASK_STACK_PROBE (1 << 24)
#define OPTION_MASK_ISA_TBM (HOST_WIDE_INT_1 << 53)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 25)
#define MASK_VECT8_RETURNS (1 << 26)
#define MASK_VZEROUPPER (1 << 27)
#define OPTION_MASK_ABI_X32 (HOST_WIDE_INT_1 << 54)
#define OPTION_MASK_ISA_XOP (HOST_WIDE_INT_1 << 55)
#define OPTION_MASK_ISA_XSAVE (HOST_WIDE_INT_1 << 56)
#define OPTION_MASK_ISA_XSAVEC (HOST_WIDE_INT_1 << 57)
#define OPTION_MASK_ISA_XSAVEOPT (HOST_WIDE_INT_1 << 58)
#define OPTION_MASK_ISA_XSAVES (HOST_WIDE_INT_1 << 59)
 #if defined(HOST_BITS_PER_WIDE_INT) && 60 >= HOST_BITS_PER_WIDE_INT
